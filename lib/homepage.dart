      ...
      body: PageView(
        ...
        children: <Widget>[
          makePage(
              ...
              description: 'Buick Skylark GS 455 Stage 1 – US vintage oldtimer muscle classic car',

            ),
          makePage(
              image: 'assets/images/two.jpg',
              title: 'Nature Reserve – NEOM, Saudi Arabia',
              description: 'Canyon carving an immense gulf in the highlands, Nature Reserve – NEOM, Saudi Arabia | The NEOM Nature Reserve region is being designed to deliver protection and restoration of biodiversity across 95% of NEOM.',
           ),
          makePage(
          ...
          makePage(
              ...
              description: "Lac de l'orceyrette en fin d'après midi avec ses mélèzes aux couleurs de l'automne. Lac de l'Orceyrette at the end of the afternoon with its larches in the colors of autumn."
          ),
        ],
      ),
    );
